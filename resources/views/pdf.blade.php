...
<head>
    ...
    <title>Relatório Prospect Brasil</title>
...
<body>
    <div id="relatorioMensal" class="cabecalho ">
        ...
        <h3 class="date">PERIODO: 01/01/2021 À 12/12/2022 </h3>
        <div class="quadrados">
    ...
    <div id="qtd" class="reunioes row">
        <table style="background-color:#e7e7e7">
            <tr>
                <td class="contadores" style="color:#434343;">
                    1250
                </td>

                <td class="contadores" style="color:#4d8b31;">
                    33
                </td>
                <td class="contadores" style="color:#434343;">
                    55
    ...
    <div id="circulos" class="reunioes row">
        <div class="mr-2">
            <img id="base6img" src="{{$imagem ?? ""}}" alt="">
        </div>
    ...
    <table class="table table-striped" style="page-break-before: always">
        <thead>
            <tr style="background-color:#999999;">
                <th class="th" colspan="2" style="text-align: center;">Números</th>
            </tr>
        </thead>
        <tbody>
            <tr>
